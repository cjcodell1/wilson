...
def write_execute_ansible(vm_names):
  ...
  with open("execute_ansible_playbooks.sh", "w") as f:
    ...
    for vm_name in vm_names:
      f.write("ansible-playbook -i inventory_" + vm_name + ".ini ansible_scripts_" + vm_name + ".yml --extra-vars \"ansible_user=controller ansible_ssh_pass=" + args.controller_pwd + " ansible_ssh_common_args='-o StrictHostKeyChecking=no'\"\n")
